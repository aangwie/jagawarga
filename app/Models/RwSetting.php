...
class RwSetting extends Model
{
    ...
    /**
     * Pastikan tabel rw_settings ada di database, buat jika belum ada
     */
    public static function ensureTableExists(): void
    {
        if (!Schema::hasTable('rw_settings')) {
            Schema::create('rw_settings', function (\Illuminate\Database\Schema\Blueprint $table) {
                $table->id();
                ...
                $table->integer('panic_radius_meters')->default(300);
